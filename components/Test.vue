...
.thumbnail-container {
  box-shadow: inset 0px 0px 80px 80px rgba(0, 0, 0, 0.75);
}

.thumbnail-mask {
  width: 100vw;
  height: 100vh;
  mask-image: url(http://www.photoshoptutorials.tv/wp-content/uploads/2017/07/LINES.png);
  mask-repeat: repeat;
  mask-position: center center;
  mask-size: 100% 100%;
}
div.thumbnail-container div img {
  z-index: -1;
}
.title {
